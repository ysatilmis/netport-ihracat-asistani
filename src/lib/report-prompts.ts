...
export const REPORT_SECTIONS: ReportSection[] = [
...

  {
    ...
    maxTokens: 500,
    buildPrompt: (product) => `
ÇIKTI FORMATI ZORUNLUSU:
Yanıtının BAŞINDA şu başlık altında 3-5 cümlelik yönetici özeti ver:
## Yönetici Özeti
[Sayısal kanıt içeren, net karar önerisi sunan 3-5 cümle]

Geri kalan detay içerik:
## Detaylar
...
- Emin değilsen o maddeyi/satırı tamamen atla.
`.trim(),
  },
