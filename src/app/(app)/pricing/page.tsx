      ...
      {user && (
        <div className="mb-10 rounded-2xl bg-white border border-slate-200/80 shadow-[0_1px_2px_rgba(16,24,40,0.04)] p-6">
          ...
          <p className="text-sm text-slate-600">
            {credits === 0 ? (
              <>
                <span className="font-semibold text-red-600">Kredin bitti.</span> Aşağıdan paket alabilirsin.
              </>
            ) : credits === 1 ? (
              <>
                <span className="font-semibold text-amber-700">1 kredin kaldı.</span> Yetmezse aşağıdan paket al.
              </>
            ) : (
              <>
                <span className="font-semibold text-emerald-700">{credits} kredi</span> kaldı.
              </>
            )}
          </p>
        </div>
